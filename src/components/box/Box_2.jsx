            ...
            {items.map((item) => (
                ...
                <div key={item.key}>
                    ...
                    <div className='pl-5 mt-5 2xl:pl-10'>
                        {/* Button */}
                        <div className='border-[#42A5F5] hover:border-[#8BC34A] border-2 border-solid rounded-3xl flex items-center justify-center w-[220px] h-11 text-[#42A5F5]  font-bold hover:text-[#7C4DFF] dark:hover:text-[#FFAB00] transition-colors duration-200 dark:text-[#42A5F5]'>
