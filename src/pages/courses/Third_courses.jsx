...
const Third_Courses = () => {
    ...
    const api2 = 'http://localhost:1337/api/jses';
    const api3 = 'http://localhost:1337/api/js-new-to-jses';
    const api4 = 'http://localhost:1337/api/newjsfeatures';
    const api5 = 'http://localhost:1337/api/jscommonuses';
    const api6 = 'http://localhost:1337/api/optimizejspoors';
    const api7 = 'http://localhost:1337/api/javascript-third-parties';
    const api8 = 'http://localhost:1337/api/dive-into-js-patterns';
