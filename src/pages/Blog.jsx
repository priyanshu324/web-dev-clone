        ...
        <>
            <div className='mt-10 lg:mt-20 dark:bg-[#202124] dark:text-white'>
                ...
                <div className='grid grid-cols-1 bg-[#f5f6f7] mb-10 dark:bg-[#202124] dark:text-white w-[420px] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-auto sm:grid sm:grid-cols-2 pb-10'>
                    <div>
                        <a href="#" className='hover:underline underline-offset-2'> <h3 className='text-7xl  mt-20 pl-5' >Blog</h3></a>
                        <p className='text-2xl leading-relaxed mt-10 pl-5 lg:w-[650px] xl:w-auto '>Our latest news, updates, and stories for developers</p>
                    </div>
                    <div className='mb-12'>
                        <figure className='bg-none'>
                            <a href="#">
                                <picture>
                                    <img src="../src/assets/blog-header.png" alt="peroid" className=' max-w-[600px] max-h-[200px] mt-20 pl-0 sm:pl-3 sm:mt-56 md:pl-14 lg:mt-36 lg:pl-36' />
                                </picture>
                            </a>
                        </figure>
                    </div>
