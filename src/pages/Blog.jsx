                ...
                <div className='grid grid-cols-1 bg-[#f5f6f7] mb-10 dark:bg-[#202124] dark:text-white w-[420px] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1380px] 2xl:w-[1536px] sm:grid sm:grid-cols-2 pb-10'>
                    ...
                    <div>
                        ...
                        <a href="#" className='hover:underline underline-offset-2'>
                            <h3 className='text-7xl mt-20 pl-5 2xl:text-7xl'>Blog</h3>
                        </a>
                         {/* Description of the banner */}
                        <p className='text-2xl leading-relaxed mt-10 pl-5 lg:w-[650px] xl:w-[750px] 2xl:text-2xl 2xl:w-[800px]'>
                    ...
                    <div className='mb-12'>
                        ...
                        <figure className='bg-none'>
                            <a href="#">
                                <picture>
                                    <img src="https://res.cloudinary.com/ddisedbxn/image/upload/v1733582514/assets/blog/dpfnu3twrgrmiqttxnhn.png" alt="peroid" className='max-w-[600px] max-h-[200px] mt-20 pl-0 sm:pl-3 sm:mt-56 md:pl-14 lg:mt-36 lg:pl-36 2xl:max-w-[800px] 2xl:max-h-[300px]' />
                                </picture>
                            </a>
                        </figure>
                    </div>
