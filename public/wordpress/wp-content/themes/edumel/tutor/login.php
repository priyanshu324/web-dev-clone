...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$edumel_demo_login_content					 = '';

	if ( isset( $edumel['edumel_demo_login_content'] ) ) {
		$edumel_demo_login_content = $edumel['edumel_demo_login_content'];
	}	
	...
	<div class="tutor-template-segment tutor-login-wrap">
		...
		<div class="tutor-login-form-wrapper">
			<div class="tutor-fs-5 tutor-color-black tutor-mb-32">
				<?php esc_html_e( 'Hi, Welcome back!', 'edumel' ); ?>
				<?php if($edumel_demo_login_content):?>
				<div class="demo-login-info">
					<?php echo edumel_wp_kses($edumel_demo_login_content);?>
				</div>
				<?php endif; ?>
			</div>
			<?php
