...
add_action( 'tgmpa_register', 'edumel_register_required_plugins' );
 ...
 */
function edumel_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html__('Redux Framework','edumel'), 
		...
		array(
			'name'               => esc_html__('WordPress Importer','edumel'), 
		...
		array(
			...
			'name'               => esc_html__('Edumel Core','edumel'), 

			'slug'               => 'edumel-core', 

			'source'             => 'https://themesvila.com/plugins/edumel-core.zip', 
		...
		array(
			...
			'name'      => esc_html__('Contact Form 7','edumel'), 
		...
		array(
			...
			'name'      => esc_html__('WooCommerce','edumel'), 
		...
		array(
			'name'               => esc_html__('Fonts Plugin | Google Fonts Typography','edumel'), 
		...
		array(
			...
			'name'      => esc_html__('MailChimp for WordPress','edumel'), 
		...
		array(
			...
			'name'               => esc_html__('Elementor Page Builder','edumel'), 
		...
		array(
			...
			'name'               => esc_html__('Tutor LMS','edumel'), 
		...
		array(
			...
			'name'               => esc_html__('One Click Demo Import','edumel'), 
