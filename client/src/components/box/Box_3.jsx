  ...
  return (
    <>
      ...
      {items.map((item) => (
        ...
        <div key={item.key} className="bg-[#F0F4F8] dark:bg-[#121212]">
...
const Box_3 = () => {
  ...
  const api1 = 'http://localhost:1337/api/home-box3s?populate=*';
  const api2 = 'http://localhost:1337/api/home-link5s?populate=*';
  const api3 = 'http://localhost:1337/api/home-link6s?populate=*';
