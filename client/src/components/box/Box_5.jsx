  ...
  return (
    <>
      ...
      {items.map((item) => (
        ...
        <div key={item.key} className="bg-[#F0F4F8] dark:bg-[#121212] pb-5">
  ...
  return (
    <>
      ...
      {items.map((item) => (
        ...
        <div key={item.key} className='sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-2 items-start bg-[#F0F4F8] dark:bg-[#121212] pb-5'>
          {/* First column */}
...
export const List_3 = ({ items }) => {
  return (
    <>
      ...
      {items.map((item) => (
        // Main container for each item (grid layout)
        <div key={item.key} className='grid grid-cols-1 sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-2 items-start bg-[#F0F4F8] dark:bg-[#121212] pb-5'>
          {/* First column */}
          <div className='flex flex-col items-start'>
            {/* Title of the first section */}
            {item.title && (
...
const Box_5 = () => {
  ...
  const api1 = 'http://localhost:1337/api/home-box5s?populate=*';
  const api2 = 'http://localhost:1337/api/home-link9s?populate=*';
  const api3 = 'http://localhost:1337/api/home-link10s?populate=*';
